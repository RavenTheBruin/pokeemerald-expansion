...
static const struct SpriteFrameImage sPicTable_Florea[] = {
    overworld_frame(gObjectEventPic_Florea, 2, 4, 0),
    overworld_frame(gObjectEventPic_Florea, 2, 4, 1),
    overworld_frame(gObjectEventPic_Florea, 2, 4, 2),
    overworld_frame(gObjectEventPic_Florea, 2, 4, 0),
    overworld_frame(gObjectEventPic_Florea, 2, 4, 0),
    overworld_frame(gObjectEventPic_Florea, 2, 4, 1),
    overworld_frame(gObjectEventPic_Florea, 2, 4, 1),
...
static const struct SpriteFrameImage sPicTable_Svoner[] = {
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 0),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 1),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 2),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 3),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 4),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 5),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 6),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 7),
    overworld_frame(gObjectEventPic_Svoner, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Ernie[] = {
    overworld_frame(gObjectEventPic_Ernie, 4, 4, 0),
    overworld_frame(gObjectEventPic_Ernie, 4, 4, 0),
    overworld_frame(gObjectEventPic_Ernie, 4, 4, 0),
    overworld_frame(gObjectEventPic_Ernie, 4, 4, 0),
    overworld_frame(gObjectEventPic_Ernie, 4, 4, 0),
