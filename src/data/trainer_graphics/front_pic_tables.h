const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_LEADER_FLOREA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_FELUCIA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_FLANNERY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_SVONER] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(LEADER_FLOREA, gTrainerFrontPic_LeaderFlorea, 0x800),
    TRAINER_SPRITE(LEADER_FELUCIA, gTrainerFrontPic_LeaderFelucia, 0x800),
    TRAINER_SPRITE(LEADER_FLANNERY, gTrainerFrontPic_LeaderFlannery, 0x800),
    TRAINER_SPRITE(LEADER_SVONER, gTrainerFrontPic_LeaderNorman, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(LEADER_FLOREA, gTrainerPalette_LeaderFlorea),
    TRAINER_PAL(LEADER_FELUCIA, gTrainerPalette_LeaderFelucia),
    TRAINER_PAL(LEADER_FLANNERY, gTrainerPalette_LeaderFlannery),
    TRAINER_PAL(LEADER_SVONER, gTrainerPalette_LeaderNorman),
